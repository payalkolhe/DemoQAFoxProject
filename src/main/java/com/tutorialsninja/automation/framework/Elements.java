...
public class Elements {
	...
	public static void TypeTextIfElementPresent(WebElement element, CharSequence[] data) {
	...
	public static void typeRandomNumber(WebElement element, int data) {
		...
		java.lang.String randomNumber = Integer.toString(rn);
		element.sendKeys(randomNumber);
	}

	public static java.lang.String getTextBoxValue(WebElement element) {
		return element.getAttribute("value");
	}

	public static java.lang.String getText(WebElement element) {
	...
	public void selectByText(WebElement element, java.lang.String text) {
	...
	public void selectByValue(WebElement element, java.lang.String value) {
		Select select = new Select(element);
		select.selectByValue(value);
	}

	public java.lang.String getFirstSelectedOption(WebElement element) {
		Select select = new Select(element);
	...
	public void deSelectByText(WebElement element, java.lang.String text) {
		Select select = new Select(element);
		select.selectByVisibleText(text);
	}
	...
	public void deSelectByValue(WebElement element, java.lang.String value) {
		Select select = new Select(element);
	...
	public java.lang.String getAlertText() {
		java.lang.String text = getAlert().getText();
		return text;
	}
	...
	public void AcceptPrompt(java.lang.String text) {
